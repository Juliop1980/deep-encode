...
daten$intervallgroup = ifelse(daten$t_average_bitrate<235,1, ifelse(daten$t_average_bitrate<375,2,ifelse(daten$t_average_bitrate<560,3, ifelse(daten$t_average_bitrate<750,4, ifelse(daten$t_average_bitrate<1050,5, ifelse(daten$t_average_bitrate<1750,6,ifelse(daten$t_average_bitrate<2350,7,ifelse(daten$t_average_bitrate<3000,8,ifelse(daten$t_average_bitrate<4300,9,ifelse(daten$t_average_bitrate<5800,10,11))))))))))

#ConvexHullWerte

hello <- as.data.frame(
daten %>%
  group_by(ï..s_video_id, intervallgroup) %>%
  summarise(maxVMAF = max(vmafPredicted, .groups = FALSE)))

#fertig
daten = merge(daten, hello, by=c("ï..s_video_id","intervallgroup"), all = T)
